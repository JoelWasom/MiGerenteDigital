                ...
                <b-card border-variant="info">
                    ...
                    <b-row>
                        <b-col sm="4" md="5" xl="6" lg="6" class="mb-1">
                            <!-- Boton Modal -->
                            <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" v-b-modal.frmProveedor variant="success"
...
import FrmProveedor from './frmProveedor.vue';
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: "provDireccion", label: "DIRECCION", sortable: true },
                { key: "provTelefono", label: "TELEFONO", sortable: true },
                ...
                .then(function (response) {
                    ...
                    for (let i = 0; i < resp.length; i++) {
                        lista.push({
                            ...
                            provDireccion : resp[i].provDireccion,
                            provTelefono : resp[i].provTelefono
                        });
                    }
                    me.items = lista;
                    me.isBusy = false;
